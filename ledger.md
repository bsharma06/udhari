...
I want to build a **Finance Ledger Application** using **Flutter**. The app should allow users to track money owed and money received, organized by entities or individuals. Below are the detailed requirements:
